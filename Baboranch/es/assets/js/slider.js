var Slider = function() {
  ...
  var position = function() {
    var sign, half = $('.activegallery').index(), x = 0, z = 0, zindex,scaleX = 1.3,scaleY = 1.3, transformOrigin;
  ...
  var calculateX = function(position, sign, width) {
    switch(sign) {
      case 1:
      case 0: return position - width / 1.25;
      case -1: return position - width / 1.25;
    }
  }
