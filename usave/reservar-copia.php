...
?>
              ...
              <div class="car-form">
                <div class="form-content">
                  ...
                  <form action="reservar.php" method="post">
                    ...
                    <input type="hidden" id="carro" name="carro">
        ...
        <div id="cotizacion">
          ...
          <div class="price-table">
            ...
            <table>
              ...
              <tr>
                <td><?php echo $semanas ?> semanas</td>
              ...
              <a class="btn waves-effect waves-light" onclick="get_email()">Cotizar</a>
          </div>
          <?php
                break;
              } //fin del if
    ...
    function seleccion(idcarro, nombrecarro, preciousd, preciomx){
      ...
      document.getElementById("carro").value=nombrecarro;
    }
    function get_email(){
      ...
      var lugar_renta='<?php echo $lugar_renta ?>';
      var fecha_renta='<?php echo $fecha_renta ?>';
      var hora_inicial='<?php echo $hora_inicial ?>';
      var lugar_entrega='<?php echo $lugar_entrega ?>';
      var fecha_entrega='<?php echo $fecha_entrega ?>';
      var hora_final='<?php echo $hora_final ?>';
      var semanas='<?php echo $semanas ?>';
      var dias='<?php echo $dias ?>';
      var preciomx='<?php echo $preciomx ?>';
      var ptotal_semanas='<?php echo $suma_semana_mx ?>';
      var ptotal_dias='<?php echo $suma_dias_mx ?>';
      var subtotal='<?php echo $subtotal_mx ?>';
      var airport_fee='<?php echo $airport_fee ?>';
      var iva='<?php echo $iva ?>';
      var ptotal='<?php echo $precio_total_mx ?>';
      var ptotal_usd='<?php echo $precio_total_usd ?>';
      var carro='<?php echo $carro ?>';
      $.POST("enviar_reserva.php",{lugar_renta: lugar_renta, fecha_renta: fecha_renta, hora_inicial: hora_inicial,
         lugar_entrega: lugar_entrega, dias: dias , fecha_entrega: fecha_entrega, hora_final: hora_final, semanas: semanas,
         ptotal_semanas: ptotal_semanas, ptotal_dias: ptotal_dias, subtotal: subtotal, airport_fee: airport_fee, iva: iva,
         ptotal: ptotal, ptotal_usd: ptotal_usd, preciomx: preciomx, carro: carro , email: email})
    }
    $(document).ready(function(){
